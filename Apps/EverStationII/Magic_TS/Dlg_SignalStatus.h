...
class CDlg_SignalStatus : public CDialog
{
// Construction
public:
	CDlg_SignalStatus(CWnd* pParent = NULL);   // standard constructor

// Dialog Data
	//{{AFX_DATA(CDlg_SignalStatus)
