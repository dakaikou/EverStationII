...
BOOL CDlg_TSAnalyzer_Epg::OnInitDialog() 
{
	...
	if (m_wndSplitter.GetSafeHwnd() == NULL)
	{
		...
		m_wndRightSplitter.CreateView(0, 0, RUNTIME_CLASS(CListView_ServiceInfo), CSize(0, 100), NULL);
		...
		m_pServiceDescription = (CListView_ServiceInfo*)m_wndRightSplitter.GetPane(0, 0);
