...
class CDlg_TSAnalyzer_Metering_Overview : public CDialog
{
// Construction
public:
	CDlg_TSAnalyzer_Metering_Overview(CWnd* pParent = NULL);   // standard constructor

// Dialog Data
	//{{AFX_DATA(CDlg_TSAnalyzer_Metering_Overview)
...
// Overrides
	...
	//{{AFX_VIRTUAL(CDlg_TSAnalyzer_Metering_Overview)
	protected:
