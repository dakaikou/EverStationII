...
class CDlg_TSAnalyzer_Metering_Pcr : public CDialog
{
// Construction
public:
	CDlg_TSAnalyzer_Metering_Pcr(CWnd* pParent = NULL);   // standard constructor

// Dialog Data
	//{{AFX_DATA(CDlg_TSAnalyzer_Metering_Pcr)
...
// Overrides
	...
	//{{AFX_VIRTUAL(CDlg_TSAnalyzer_Metering_Pcr)
	protected:
...
protected:
	...
	CNaviList_PcrGuide*		m_pNaviPane;
