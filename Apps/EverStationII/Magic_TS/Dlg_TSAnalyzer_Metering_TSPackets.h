...
#pragma once
#endif // _MSC_VER > 1000
// Dlg_TSAnalyzer_TSPacketsList.h : header file
//
#include <afxcmn.h>
#include "..\resource.h"
...
class CDlg_TSAnalyzer_Metering_TSPackets : public CDialog
{
// Construction
public:
	CDlg_TSAnalyzer_Metering_TSPackets(CWnd* pParent = NULL);   // standard constructor

// Dialog Data
	//{{AFX_DATA(CDlg_TSAnalyzer_Metering_TSPackets)
...
// Overrides
	...
	//{{AFX_VIRTUAL(CDlg_TSAnalyzer_Metering_TSPackets)
	protected:
...
//	CString m_strFileName;
	...
	//{{AFX_MSG(CDlg_TSAnalyzer_TSPacketsList)
