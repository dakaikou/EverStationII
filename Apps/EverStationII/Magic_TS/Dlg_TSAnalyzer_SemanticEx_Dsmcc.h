...
#include "GuiWnd_NaviList_DsmccGuide.h"
#include "../Common/TreeView_XMLBrowser.h"
#include "..\resource.h"

class CDlg_TSAnalyzer_SemanticEx_Dsmcc : public CDialog
{
// Construction
public:
	CDlg_TSAnalyzer_SemanticEx_Dsmcc(CWnd* pParent = NULL);   // standard constructor

// Dialog Data
	//{{AFX_DATA(CDlg_TSAnalyzer_SemanticEx_Dsmcc)
...
// Overrides
	...
	//{{AFX_VIRTUAL(CDlg_TSAnalyzer_SemanticEx_Dsmcc)
	protected:
...
protected:
	...
	CNaviList_DsmccGuide*			m_pNaviPane;
