...
class CDlg_TSAnalyzer_Semantic_Bouquets : public CDialog
{
// Construction
public:
	CDlg_TSAnalyzer_Semantic_Bouquets(CWnd* pParent = NULL);   // standard constructor

// Dialog Data
	//{{AFX_DATA(CDlg_TSAnalyzer_Semantic_Bouquets)
...
// Overrides
	...
	//{{AFX_VIRTUAL(CDlg_TSAnalyzer_Semantic_Bouquets)
	protected:
...
public:
	...
	CNaviTree_BouquetGuide*			m_pNaviPane;
