...
class CDlg_TSAnalyzer_Syntax_PesEs : public CDialog
{
// Construction
public:
	CDlg_TSAnalyzer_Syntax_PesEs(CWnd* pParent = NULL);   // standard constructor

// Dialog Data
	//{{AFX_DATA(CDlg_TSAnalyzer_Syntax_PesEs)
...
// Overrides
	...
	//{{AFX_VIRTUAL(CDlg_TSAnalyzer_Syntax_PesEs)
	protected:
...
protected:
	...
	CNaviTree_PesEsGuide*			m_pNaviPane;
