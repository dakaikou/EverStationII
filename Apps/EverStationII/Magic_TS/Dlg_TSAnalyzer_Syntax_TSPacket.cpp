...
/////////////////////////////////////////////////////////////////////////////
// CDlg_TSAnalyzer_Syntax_TSPacket dialog
#include <assert.h>
...
CDlg_TSAnalyzer_Syntax_TSPacket::CDlg_TSAnalyzer_Syntax_TSPacket(CWnd* pParent /*=NULL*/)
	: CDialog(CDlg_TSAnalyzer_Syntax_TSPacket::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDlg_TSAnalyzer_Syntax_TSPacket)
...
void CDlg_TSAnalyzer_Syntax_TSPacket::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlg_TSAnalyzer_Syntax_TSPacket)
		// NOTE: the ClassWizard will add DDX and DDV calls here
	//}}AFX_DATA_MAP
}


BEGIN_MESSAGE_MAP(CDlg_TSAnalyzer_Syntax_TSPacket, CDialog)
	//{{AFX_MSG_MAP(CDlg_TSAnalyzer_Syntax_TSPacket)
...
/////////////////////////////////////////////////////////////////////////////
// CDlg_TSAnalyzer_Syntax_TSPacket message handlers

//void CDlg_TSAnalyzer_Syntax_TSPacket::Set(int offline)
//{
//}

void CDlg_TSAnalyzer_Syntax_TSPacket::Reset(void)
{
	CComboBox*   pCtrl;
	CWnd*		 pBtn;
	CSliderCtrl* pSlider;
...
BOOL CDlg_TSAnalyzer_Syntax_TSPacket::OnInitDialog()
{
	...
	if (m_wndSplitter.GetSafeHwnd() == NULL)
	{
		...
		m_pSyntaxTree = (CTreeView_XMLBrowser*)m_wndSplitter.GetPane(0, 0);
		m_pSyntaxTree->Init("TS包语法分析");
		m_pSyntaxTree->m_hNotifyParent = GetSafeHwnd();
#if BYTE_BUFFER_USE_LISTCTRL_VIEW
		m_pHexList = (CListView_ByteBuffer*)m_wndSplitter.GetPane(0, 1);
#else
		m_pHexList = (CHexEditView_ByteBuffer*)m_wndSplitter.GetPane(0, 1);
...
void CDlg_TSAnalyzer_Syntax_TSPacket::OnBtnSearch()
{
...
void CDlg_TSAnalyzer_Syntax_TSPacket::OnBtnReset()
{
	// TODO: Add your control notification handler code here
	CComboBox*		pCtrl;
	int				item_count;
...
void CDlg_TSAnalyzer_Syntax_TSPacket::OnBtnClear()
{
	// TODO: Add your control notification handler code here
	CWnd*			pBtn = NULL;
...
void CDlg_TSAnalyzer_Syntax_TSPacket::CancelTrigger(void)
{
	CWnd*			pBtn = NULL;
...
void CDlg_TSAnalyzer_Syntax_TSPacket::OnBtnNext()
{
	// TODO: Add your control notification handler code here
	CTSMagicView* pTSMagicView = CTSMagicView::GetView();
	...
	if (nPos <= pSlider->GetRangeMax())
	{
		...
		{
			m_pHexList->Reset();
			m_pHexList->DisplayByteBuffer(packet_buf, packet_length);
		}
...
void CDlg_TSAnalyzer_Syntax_TSPacket::OnBtnPre()
{
	// TODO: Add your control notification handler code here
	CTSMagicView* pTSMagicView = CTSMagicView::GetView();
	CSliderCtrl* pSlider = (CSliderCtrl*)GetDlgItem(IDC_SLIDER_TS_PACKET);
...
void CDlg_TSAnalyzer_Syntax_TSPacket::OnHScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar)
{
...
void CDlg_TSAnalyzer_Syntax_TSPacket::UpdateCatchResult(void)
{
	CWnd*			pWnd;
	CSliderCtrl*	pSlider = (CSliderCtrl*)GetDlgItem(IDC_SLIDER_TS_PACKET);
	CTSMagicView*	pTSMagicView = CTSMagicView::GetView();
...
void CDlg_TSAnalyzer_Syntax_TSPacket::UpdatePIDList(void)
{
	int					nCurSel;
	char				pszCurText[64];
	char				pszPIDText[64];
...
void CDlg_TSAnalyzer_Syntax_TSPacket::OnDropdownCmbPid()
{
	// TODO: Add your control notification handler code here
	m_bSelectingPID = 1;
}

void CDlg_TSAnalyzer_Syntax_TSPacket::OnCloseupCmbPid()
{
	// TODO: Add your control notification handler code here
	m_bSelectingPID = 0;	
}

BOOL CDlg_TSAnalyzer_Syntax_TSPacket::VerifySearchConditions( void )
{
...
/*
void CDlg_TSAnalyzer_TSPacketSyntax::OnSelchangeCmbDiscontinuityIndicator() 
{
	// TODO: Add your control notification handler code here
...
*/
/*
void CDlg_TSAnalyzer_TSPacketSyntax::OnSelchangeCmbRandomAccessIndicator() 
{
	// TODO: Add your control notification handler code here
	if( !VerifySearchConditions() ){
...
*/
/*
void CDlg_TSAnalyzer_TSPacketSyntax::OnSelchangeCmbElementaryStreamPriorityIndicator() 
{
	// TODO: Add your control notification handler code here
	if( !VerifySearchConditions() ){
...
*/
void CDlg_TSAnalyzer_Syntax_TSPacket::OnSelchangeCmbPcrFlag()
{
	// TODO: Add your control notification handler code here
	if( !VerifySearchConditions() ){
...
/*
void CDlg_TSAnalyzer_TSPacketSyntax::OnSelchangeCmbOpcrFlag() 
{
	// TODO: Add your control notification handler code here
	if( !VerifySearchConditions() ){
...
*/
/*
void CDlg_TSAnalyzer_TSPacketSyntax::OnSelchangeCmbSplicingPointFlag() 
{
	// TODO: Add your control notification handler code here
	if( !VerifySearchConditions() ){
...
*/
/*
void CDlg_TSAnalyzer_TSPacketSyntax::OnSelchangeCmbTransportPrivateDataFlag() 
{
	// TODO: Add your control notification handler code here
	if( !VerifySearchConditions() ){
...
*/
/*
void CDlg_TSAnalyzer_TSPacketSyntax::OnSelchangeCmbAdaptationFieldExtensionFlag() 
{
	// TODO: Add your control notification handler code here
	if( !VerifySearchConditions() ){
...
int CDlg_TSAnalyzer_Syntax_TSPacket::GetTriggerParams(uint8_t* pucMask, uint8_t* pucData, int length)
{
	int rtcode = -1;
...
void CDlg_TSAnalyzer_Syntax_TSPacket::OnSize(UINT nType, int cx, int cy)
{
...
BOOL CDlg_TSAnalyzer_Syntax_TSPacket::OnNotify(WPARAM wParam, LPARAM lParam, LRESULT* pResult)
{
...
void CDlg_TSAnalyzer_Syntax_TSPacket::OnDestroy()
{
	CDialog::OnDestroy();
