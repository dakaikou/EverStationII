...
#pragma once
#endif // _MSC_VER > 1000
// Dlg_TSAnalyzer_Syntax_TSPacket.h : header file
//
#include "..\resource.h"
/////////////////////////////////////////////////////////////////////////////
...
class CDlg_TSAnalyzer_Syntax_TSPacket : public CDialog
{
// Construction
public:
	CDlg_TSAnalyzer_Syntax_TSPacket(CWnd* pParent = NULL);   // standard constructor

// Dialog Data
	//{{AFX_DATA(CDlg_TSAnalyzer_TSPacketSyntax)
...
#if BYTE_BUFFER_USE_LISTCTRL_VIEW
	CListView_ByteBuffer*		m_pHexList;
#else
...
protected:
	...
	//{{AFX_MSG(CDlg_TSAnalyzer_TSPacketSyntax)
