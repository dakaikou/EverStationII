#if !defined(AFX_DLG_WATCH_TELETEXT_H__9AC3530E_7E02_4030_AF61_A0EA3A88C277__INCLUDED_)
#define AFX_DLG_WATCH_TELETEXT_H__9AC3530E_7E02_4030_AF61_A0EA3A88C277__INCLUDED_

#if _MSC_VER > 1000
#pragma once
#endif // _MSC_VER > 1000
// Dlg_WatchTeletext.h : header file
//
...
class CDlg_TSAnalyzer_Teletext : public CDialog
{
// Construction
public:
	CDlg_TSAnalyzer_Teletext(CWnd* pParent = NULL);   // standard constructor

// Dialog Data
	//{{AFX_DATA(CDlg_TSAnalyzer_Teletext)
	enum { IDD = IDD_TS_ANALYZER_TELETEXT };
	CListCtrl		m_listTeletextPID;
//	CComboBox		m_cmbServices;
	#if MFC_CONTROL
	CTreeCtrl		m_treeTeletextSyntax;
	#else
	//CTreeListCtrl	m_treeTeletextSyntax;
	#endif
	//}}AFX_DATA
...
// Overrides
	...
	//{{AFX_VIRTUAL(CDlg_TSAnalyzer_Teletext)
	protected:
...
//	CESDecoder*			m_pActiveAudDecoder;
	...
	//{{AFX_MSG(CDlg_TSAnalyzer_Teletext)
	virtual BOOL OnInitDialog();
	afx_msg void OnSize(UINT nType, int cx, int cy);
	afx_msg void OnBtnTeletextTrigger();
//	afx_msg void OnBtnWatch();
//	afx_msg void OnBtnDts();
//	afx_msg void OnBtnPts();
//	afx_msg void OnSelchangeCmbServices();
	afx_msg void OnDblclkListTeletextPid(NMHDR* pNMHDR, LRESULT* pResult);
	//}}AFX_MSG
...
#endif // !defined(AFX_DLG_WATCH_TELETEXT_H__9AC3530E_7E02_4030_AF61_A0EA3A88C277__INCLUDED_)
