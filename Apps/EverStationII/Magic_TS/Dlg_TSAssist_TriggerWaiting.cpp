...
CDlg_TSAssist_TriggerWaiting::CDlg_TSAssist_TriggerWaiting(CWnd* pParent /*=NULL*/)
	: CDialog(CDlg_TSAssist_TriggerWaiting::IDD, pParent)
{
	//{{AFX_DATA_INIT(CDlg_TSAssist_TriggerWaiting)
	//}}AFX_DATA_INIT
}


void CDlg_TSAssist_TriggerWaiting::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CDlg_TSAssist_TriggerWaiting)
	//}}AFX_DATA_MAP
}

BEGIN_MESSAGE_MAP(CDlg_TSAssist_TriggerWaiting, CDialog)
	//{{AFX_MSG_MAP(CDlg_TSAssist_TriggerWaiting)
	ON_WM_CREATE()
	ON_WM_TIMER()
	ON_WM_SHOWWINDOW()
...
/////////////////////////////////////////////////////////////////////////////
// CDlg_TSAssist_TriggerWaiting message handlers

int CDlg_TSAssist_TriggerWaiting::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
...
void CDlg_TSAssist_TriggerWaiting::OnTimer(UINT_PTR nIDEvent) 
{
...
void CDlg_TSAssist_TriggerWaiting::OnShowWindow(BOOL bShow, UINT nStatus) 
{
...
BOOL CDlg_TSAssist_TriggerWaiting::OnInitDialog() 
{
...
void CDlg_TSAssist_TriggerWaiting::OnBtnStop() 
{
