...
/////////////////////////////////////////////////////////////////////////////
// CDlg_TSAssist_TriggerWaiting dialog
#include <afxwin.h>
#include "..\resource.h"

class CDlg_TSAssist_TriggerWaiting : public CDialog
{
// Construction
public:
	CDlg_TSAssist_TriggerWaiting(CWnd* pParent = NULL);   // standard constructor

// Dialog Data
	//{{AFX_DATA(CDlg_TSAssist_TriggerWaiting)
...
// Overrides
	...
	//{{AFX_VIRTUAL(CDlg_TSAssist_TriggerWaiting)
	protected:
...
protected:
	...
	//{{AFX_MSG(CDlg_TSAssist_TriggerWaiting)
