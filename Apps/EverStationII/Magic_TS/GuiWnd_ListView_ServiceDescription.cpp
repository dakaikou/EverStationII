...
IMPLEMENT_DYNCREATE(CListView_ServiceDescription, CListView)

CListView_ServiceDescription::CListView_ServiceDescription()
{
}
...
BEGIN_MESSAGE_MAP(CListView_ServiceDescription, CListView)
...
void CListView_ServiceDescription::OnDraw(CDC* pDC)
{
...
#ifdef _DEBUG
void CListView_ServiceDescription::AssertValid() const
{
	CListView::AssertValid();
}

void CListView_ServiceDescription::Dump(CDumpContext& dc) const
{
	CListView::Dump(dc);
}
#endif //_DEBUG
...
BOOL CListView_ServiceDescription::Create(LPCTSTR lpszClassName, LPCTSTR lpszWindowName, DWORD dwStyle, const RECT& rect, CWnd* pParentWnd, UINT nID, CCreateContext* pContext)
{
...
void CListView_ServiceDescription::Set(int offline)
{
}

void CListView_ServiceDescription::Reset(void)
{
...
*/
void CListView_ServiceDescription::Update(uint16_t network_id, uint16_t transport_stream_id, uint16_t service_id)
{
	CSDT*							pSDT;
	CNIT*							pNIT;
...
int CListView_ServiceDescription::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
...
void CListView_ServiceDescription::OnSize(UINT nType, int cx, int cy)
{
