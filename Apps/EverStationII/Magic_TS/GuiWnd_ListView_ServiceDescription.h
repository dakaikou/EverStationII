...
#pragma once
#endif // _MSC_VER > 1000
// ListView_ServiceDescription.h : header file
//
#include <stdint.h>

/////////////////////////////////////////////////////////////////////////////
// CListView_ServiceDescription view
#include <afxcview.h>

class CListView_ServiceDescription : public CListView
{
public:
	CListView_ServiceDescription();           // protected constructor used by dynamic creation
	DECLARE_DYNCREATE(CListView_ServiceDescription)
...
// Overrides
	...
	//{{AFX_VIRTUAL(CListView_ServiceDescription)
	public:
...
// Implementation
protected:
	virtual ~CListView_ServiceDescription();
#ifdef _DEBUG
...
protected:
	//{{AFX_MSG(CListView_ServiceDescription)
