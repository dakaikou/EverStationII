...
#include "GuiWnd_NaviList_PcrGuide.h"


// CListView_PcrInfo

IMPLEMENT_DYNCREATE(CNaviList_PcrGuide, CListView)

CNaviList_PcrGuide::CNaviList_PcrGuide()
{
...
BEGIN_MESSAGE_MAP(CNaviList_PcrGuide, CListView)
	ON_WM_CREATE()
	ON_WM_SIZE()
END_MESSAGE_MAP()
...
#ifdef _DEBUG
void CNaviList_PcrGuide::AssertValid() const
{
	CListView::AssertValid();
}

#ifndef _WIN32_WCE
void CNaviList_PcrGuide::Dump(CDumpContext& dc) const
{
	CListView::Dump(dc);
}
#endif
...
BOOL CNaviList_PcrGuide::Create(LPCTSTR lpszClassName, LPCTSTR lpszWindowName, DWORD dwStyle, const RECT& rect, CWnd* pParentWnd, UINT nID, CCreateContext* pContext)
{
...
void CNaviList_PcrGuide::Reset(void)
{
...
void CNaviList_PcrGuide::Set(int offline)
{
}



int CNaviList_PcrGuide::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
...
void CNaviList_PcrGuide::OnSize(UINT nType, int cx, int cy)
{
