...
#include "stdafx.h"
#include "GuiWnd_NaviTree_BouquetGuide.h"
...
IMPLEMENT_DYNCREATE(CNaviTree_BouquetGuide, CTreeView)

CNaviTree_BouquetGuide::CNaviTree_BouquetGuide()
{
	m_hRootItem = NULL;
}
...
BEGIN_MESSAGE_MAP(CNaviTree_BouquetGuide, CTreeView)
	//{{AFX_MSG_MAP(CNaviTree_Bouquets)
	ON_WM_CREATE()
	//}}AFX_MSG_MAP
	ON_NOTIFY_REFLECT(NM_DBLCLK, &CNaviTree_BouquetGuide::OnNMDblclk)
	ON_NOTIFY_REFLECT(TVN_SELCHANGED, &CNaviTree_BouquetGuide::OnTvnSelchanged)
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CNaviTree_Bouquets drawing

void CNaviTree_BouquetGuide::OnDraw(CDC* pDC)
{
...
#ifdef _DEBUG
void CNaviTree_BouquetGuide::AssertValid() const
{
	CTreeView::AssertValid();
}

void CNaviTree_BouquetGuide::Dump(CDumpContext& dc) const
{
	CTreeView::Dump(dc);
}
#endif //_DEBUG
...
BOOL CNaviTree_BouquetGuide::Create(LPCTSTR lpszClassName, LPCTSTR lpszWindowName, DWORD dwStyle, const RECT& rect, CWnd* pParentWnd, UINT nID, CCreateContext* pContext) 
{
...
int CNaviTree_BouquetGuide::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
...
void CNaviTree_BouquetGuide::UpdateBAT(CBAT* pBAT)
{
	TV_INSERTSTRUCT TreeCtrlItem;
...
void CNaviTree_BouquetGuide::DeleteChildItems(HTREEITEM hParentItem)
{
	HTREEITEM hChildItem;
	HTREEITEM hOldItem;
...
void CNaviTree_BouquetGuide::Reset(void)
{
	DeleteChildItems(m_hRootItem);
}

void CNaviTree_BouquetGuide::Set(HWND hwndReceiver, int offline)
{
	m_hwndReceiver = hwndReceiver;
}

void CNaviTree_BouquetGuide::OnNMDblclk(NMHDR* pNMHDR, LRESULT* pResult)
{
	// TODO: 在此添加控件通知处理程序代码
//#if DEBUG_BAT
//	CTreeCtrl& treeCtrl = GetTreeCtrl();
...
void CNaviTree_BouquetGuide::OnTvnSelchanged(NMHDR* pNMHDR, LRESULT* pResult)
{
