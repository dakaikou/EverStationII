...
IMPLEMENT_DYNCREATE(CNaviTree_PsiSiSectionGuide, CTreeView)

CNaviTree_PsiSiSectionGuide::CNaviTree_PsiSiSectionGuide()
{
	m_hPatItem = NULL;
	m_hPmtItem = NULL;
	m_hCatItem = NULL;
...
BEGIN_MESSAGE_MAP(CNaviTree_PsiSiSectionGuide, CTreeView)
	//{{AFX_MSG_MAP(CPane_PsiSiTableTreeView)
	ON_WM_CREATE()
	//ON_NOTIFY_REFLECT(NM_DBLCLK, OnDblclk)
	ON_NOTIFY_REFLECT(NM_DBLCLK, &CNaviTree_PsiSiSectionGuide::OnNMDblclk)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
void CNaviTree_PsiSiSectionGuide::OnDraw(CDC* pDC)
{
...
#ifdef _DEBUG
void CNaviTree_PsiSiSectionGuide::AssertValid() const
{
	CTreeView::AssertValid();
}

void CNaviTree_PsiSiSectionGuide::Dump(CDumpContext& dc) const
{
	CTreeView::Dump(dc);
}
#endif //_DEBUG
...
BOOL CNaviTree_PsiSiSectionGuide::Create(LPCTSTR lpszClassName, LPCTSTR lpszWindowName, DWORD dwStyle, const RECT& rect, CWnd* pParentWnd, UINT nID, CCreateContext* pContext) 
{
...
int CNaviTree_PsiSiSectionGuide::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
...
void CNaviTree_PsiSiSectionGuide::UpdatePAT(int section_number, CPAT* pPAT)
{
	TV_INSERTSTRUCT TreeCtrlItem;
	char			pszText[64];
...
void CNaviTree_PsiSiSectionGuide::UpdatePMT(int section_number, CPMT* pPMT)
{
	TV_INSERTSTRUCT TreeCtrlItem;
	char			pszText[256];
...
void CNaviTree_PsiSiSectionGuide::UpdateTDT(CTDT* pTDT)
{
	CTreeCtrl& treeCtrl = GetTreeCtrl();
...
void CNaviTree_PsiSiSectionGuide::UpdateTOT(CTOT* pTOT)
{
	CTreeCtrl& treeCtrl = GetTreeCtrl();
...
void CNaviTree_PsiSiSectionGuide::UpdateRST(CRST* pRST)
{
	CTreeCtrl& treeCtrl = GetTreeCtrl();
...
void CNaviTree_PsiSiSectionGuide::UpdateCMT(CCMT* pCMT)
{
	TV_INSERTSTRUCT TreeCtrlItem;
	char			pszText[256];
	...
	if (pCMT != NULL)
	{
		...
		if (treeCtrl.ItemHasChildren(hParentItem))
		{
			...
			while (hPIDItem != NULL)
			{
				...
				if (strcmp(pszText, strTemp.GetBuffer(256)) == 0)
				{
					find_pid_item = 1;
					break;
				}
...
void CNaviTree_PsiSiSectionGuide::UpdateCAT(int section_number, CCAT* pCAT)
{
	TV_INSERTSTRUCT TreeCtrlItem;
	char			pszText[64];
...
void CNaviTree_PsiSiSectionGuide::UpdateTSDT(int section_number, CTSDT* pTSDT)
{
	TV_INSERTSTRUCT TreeCtrlItem;
	char			pszText[64];
	//int				section_index;
...
void CNaviTree_PsiSiSectionGuide::UpdateINT(int section_number, CINT* pINT)
{
	TV_INSERTSTRUCT TreeCtrlItem;
	char			pszText[64];
...
void CNaviTree_PsiSiSectionGuide::UpdateAIT(int section_number, CAIT* pAIT)
{
	TV_INSERTSTRUCT TreeCtrlItem;
	char			pszText[64];
...
void CNaviTree_PsiSiSectionGuide::UpdateNIT(int section_number, CNIT* pNIT)
{
	TV_INSERTSTRUCT TreeCtrlItem;
	char			pszText[256];
	CString			strTemp;
...
void CNaviTree_PsiSiSectionGuide::Set(HWND hwndReceiver, int offline)
{
	m_hwndReceiver = hwndReceiver;
}

void CNaviTree_PsiSiSectionGuide::Reset(void)
{
	CTreeCtrl& treeCtrl = GetTreeCtrl();
...
void CNaviTree_PsiSiSectionGuide::UpdateBAT(int section_number, CBAT* pBAT)
{
	TV_INSERTSTRUCT TreeCtrlItem;
	char			pszText[256];
	CString			strTemp;
...
void CNaviTree_PsiSiSectionGuide::UpdateSDT(int section_number, CSDT* pSDT)
{
	TV_INSERTSTRUCT TreeCtrlItem;
	char			pszText[256];
...
void CNaviTree_PsiSiSectionGuide::UpdateEIT(int section_number, CEIT* pEIT)
{
	TV_INSERTSTRUCT TreeCtrlItem;
	char			pszText[256];
	CString			strTemp;
...
void CNaviTree_PsiSiSectionGuide::UpdateDSMCC(int section_number, CPVT* pPVT)
{
	TV_INSERTSTRUCT TreeCtrlItem;
	char			pszText[256];
	CString			strTemp;
...
void CNaviTree_PsiSiSectionGuide::UpdateMPE(int section_number, CMPE* pMPE)
{
	TV_INSERTSTRUCT TreeCtrlItem;
	char			pszText[64];
	CString			strTemp;
...
void CNaviTree_PsiSiSectionGuide::DeleteChildItems(HTREEITEM hParentItem)
{
...
void CNaviTree_PsiSiSectionGuide::OnNMDblclk(NMHDR* pNMHDR, LRESULT* pResult)
{
	// TODO: 在此添加控件通知处理程序代码
	//uint16_t	  usKeyID;
