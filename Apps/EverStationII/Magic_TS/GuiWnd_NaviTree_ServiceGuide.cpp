...
IMPLEMENT_DYNCREATE(CNaviTree_ServiceGuide, CTreeView)

CNaviTree_ServiceGuide::CNaviTree_ServiceGuide()
{
	m_hRootItem = NULL;
}
...
BEGIN_MESSAGE_MAP(CNaviTree_ServiceGuide, CTreeView)
	//{{AFX_MSG_MAP(CNaviTree_Services)
	ON_WM_CREATE()
	//}}AFX_MSG_MAP
	ON_NOTIFY_REFLECT(TVN_SELCHANGED, &CNaviTree_ServiceGuide::OnTvnSelchanged)
	ON_NOTIFY_REFLECT(NM_DBLCLK, &CNaviTree_ServiceGuide::OnNMDblclk)
END_MESSAGE_MAP()

/////////////////////////////////////////////////////////////////////////////
// CNaviTree_Services drawing

void CNaviTree_ServiceGuide::OnDraw(CDC* pDC)
{
...
#ifdef _DEBUG
void CNaviTree_ServiceGuide::AssertValid() const
{
	CTreeView::AssertValid();
}

void CNaviTree_ServiceGuide::Dump(CDumpContext& dc) const
{
	CTreeView::Dump(dc);
}
#endif //_DEBUG
...
BOOL CNaviTree_ServiceGuide::Create(LPCTSTR lpszClassName, LPCTSTR lpszWindowName, DWORD dwStyle, const RECT& rect, CWnd* pParentWnd, UINT nID, CCreateContext* pContext) 
{
...
int CNaviTree_ServiceGuide::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
...
void CNaviTree_ServiceGuide::Set(HWND hwndReceiver, int offline)
{
	m_hwndReceiver = hwndReceiver;
}

void CNaviTree_ServiceGuide::Reset(void)
{
	CTreeCtrl& treeCtrl = GetTreeCtrl();
...
void CNaviTree_ServiceGuide::UpdateNIT(CNIT* pNIT)
{
	TV_INSERTSTRUCT TreeCtrlItem;
...
void CNaviTree_ServiceGuide::UpdateSDT(CSDT* pSDT)
{
	TV_INSERTSTRUCT TreeCtrlItem;
	char			pszText[MAX_PATH];
...
void CNaviTree_ServiceGuide::OnTvnSelchanged(NMHDR* pNMHDR, LRESULT* pResult)
{
...
void CNaviTree_ServiceGuide::OnNMDblclk(NMHDR* pNMHDR, LRESULT* pResult)
{
	// TODO: 在此添加控件通知处理程序代码
...
void CNaviTree_ServiceGuide::DeleteChildItems(HTREEITEM hParentItem)
{
