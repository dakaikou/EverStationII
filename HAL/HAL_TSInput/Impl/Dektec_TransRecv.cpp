...
#ifdef _WIN64
#else
#include "../Include/Dektec_TransRecv.h"
...
ULONG dektec_transmit_fini(void)
{
	return 0;
}

ULONG dektec_transmit_init(void)
{
#ifdef _WIN64
	return -1;
#else
...
ULONG dektec_start_transmit(int bitrate)
{
#ifdef _WIN64
	return -1;
#else
...
ULONG dektec_transmit(unsigned char *buffer, int count)
{
#ifdef _WIN64
#else
	DTAPI_RESULT dr = -1;
...
ULONG dektec_stop_transmit(void)
{
#ifdef _WIN64
#else
...
ULONG dektec_receive_init(void)
{
#ifdef _WIN64
	return -1;
#else
...
ULONG dektec_start_receive(void)
{
#ifdef _WIN64
	return -1;
#else
...
ULONG dektec_receive(unsigned char *buffer, int count)
{
	ULONG	rtcode = 0;
...
ULONG dektec_stop_receive(void)
{
#ifdef _WIN64
#else
	DTAPI_RESULT dr = -1;
...
ULONG dektec_receive_fini(void)
{
#ifdef _WIN64
#else
...
ULONG dektec_get_asiin_bitrate(void)
{
	int	rtcode = -1;
