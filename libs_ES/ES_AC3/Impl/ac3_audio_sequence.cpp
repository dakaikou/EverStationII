...
extern S32  AC3_bit_allocate(U8 fscod, AC3_bsi_t *bsi, AC3_audblk_t *audblk);
...
extern void AC3_downmix(AC3_audblk_t *audblk, AC3_bsi_t* bsi, stream_samples_t samples, S16 *s16_samples);
extern S32  AC3_exp_unpack(U8 expstr, S8 absexp, S8* exps, U8 ngrps, U16 *dest);

extern S32 AC3_sanity_check(AC3_syncinfo_t *syncinfo, AC3_bsi_t *bsi, AC3_audblk_t *audblk);
