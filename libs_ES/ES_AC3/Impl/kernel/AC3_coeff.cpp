...
static const U32 u32_scale_factors[25] = 
{
	0x38000000, //2 ^ -(0 + 15)
	0x37800000, //2 ^ -(1 + 15)
	0x37000000, //2 ^ -(2 + 15)
...
//static S16  coeff_get_mantissa(FIFO_t* pbs, U16 bap, U16 dithflag);
static void coeff_uncouple_ch(double samples[], AC3_bsi_t *bsi, AC3_audblk_t *audblk, U32 ch);

// Convert a 0.15 fixed point number into IEEE single
// precision floating point and scale by 2^-exp
__forceinline static float convert_to_float(U16 exp, S16 mantissa)
{
...
//		if (dithflag)
//		{
//			mantissa = (U16)(46340.0 * rand() / RAND_MAX) - 23170;
//		}
//		else
//		{
//			mantissa = 0;
