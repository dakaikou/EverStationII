...
int ac3_present_unaligned_nal_to_xml(uint8_t* nal_buf, int nal_length, HALForXMLDoc* pxmlDoc, tinyxml2::XMLElement* pxmlParentNode)
{
...
int ac3_present_unknown_nal_to_xml(uint8_t* nal_buf, int nal_length, HALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode)
{
	int rtcode = AC3_NO_ERROR;
...
int	ac3_decode_syncinfo_to_xml(uint8_t* syncinfo_buf, int syncinfo_length, HALForXMLDoc* pxmlDoc, AC3_syncinfo_t* pac3_syncinfo)
{
...
int	ac3_decode_syncframe_to_xml(uint8_t* es_frame_buf, int es_frame_length, HALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode, AC3_syncframe_t* pAC3Syncframe)
{
	int		rtcode = AC3_UNKNOWN_ERROR;
	int     header_size = 4;
	char    pszTemp[64];
