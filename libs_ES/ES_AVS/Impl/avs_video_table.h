...
const S32 AVS_LUT_cc[12] = {0, 0, 0, 0, 1, 2, 1, 2, 1, 2, 1, 2};

const S32 AVS_LUT_Chroma_QP[] = 
{
	42, 43, 43, 44, 44, 45, 45, 46, 46, 47, 47, 48, 48, 48, 49, 49, 49, 50, 50, 50, 51
};

const S32 AVS_LUT_DequantTable[64] = 
{
...
const S32 AVS_LUT_ShiftTable[64] = 
{
