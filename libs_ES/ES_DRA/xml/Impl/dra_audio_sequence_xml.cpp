...
int dra_present_unaligned_nal_to_xml(uint8_t* nal_buf, int nal_length, HALForXMLDoc* pxmlDoc, tinyxml2::XMLElement* pxmlParentNode)
{
...
int dra_present_unknown_nal_to_xml(uint8_t* nal_buf, int nal_length, HALForXMLDoc* pxmlDoc, tinyxml2::XMLElement* pxmlParentNode)
{
	int rtcode = DRA_NO_ERROR;
...
int	dra_decode_frame_to_xml(uint8_t* es_frame_buf, int es_frame_length, HALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode, DRA_Frame_t* pDraFrame)
{
