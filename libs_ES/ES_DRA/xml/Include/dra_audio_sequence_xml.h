...
_CDL_EXPORT int dra_present_unaligned_nal_to_xml(uint8_t* nal_buf, int nal_length, HALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode);
_CDL_EXPORT int dra_present_unknown_nal_to_xml(uint8_t* nal_buf, int nal_length, HALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode);

_CDL_EXPORT int	dra_decode_frame_to_xml(uint8_t* adts_fixed_header_buf, int adts_fixed_header_length, HALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode, DRA_Frame_t* pdra_frame = NULL);
