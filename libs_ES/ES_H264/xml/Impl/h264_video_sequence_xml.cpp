...
int h264_present_unaligned_nal_to_xml(uint8_t* segment_buf, int prefix_length, int nal_length, HALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode)
{
...
int h264_present_unknown_nal_to_xml(uint8_t* segment_buf, int prefix_length, int nal_length, HALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode)
{
	int rtcode = H264_NO_ERROR;
