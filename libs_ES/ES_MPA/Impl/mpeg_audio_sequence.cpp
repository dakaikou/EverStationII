...
//		num_of_slots = (S32)(144 * header.bit_rate / header.sampling_rate) + header.padding_bit;
...
//		paudio->start = 0;
////		paudio->buffer = (U8 *)malloc(sizeof(S16) * length);
//
//#if MPEG_AUDIO_BITS_PER_SAMPLE == 16
//		paudio->buffer = (U8 *)malloc(sizeof(S16) * length);
//#else
...
//
//		pucSample = (U8*)merge.firstSample;
//
//	#if MPEG_AUDIO_BITS_PER_SAMPLE == 16
