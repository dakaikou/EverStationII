...
//public functions
_CDL_EXPORT int mpga_decode_unaligned_nal_to_xml(uint8_t* nal_buf, int nal_size, HALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode);
_CDL_EXPORT int mpga_decode_unknown_nal_to_xml(uint8_t* nal_buf, int nal_size, HALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode);
