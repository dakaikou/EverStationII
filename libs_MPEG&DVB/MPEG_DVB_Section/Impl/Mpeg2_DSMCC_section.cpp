...
//int MPEG2_DSMCC_DDM_DecodeSection(uint8_t *section_buf, int section_size, dsmcc_section_t* pdsmcc_section)
//{
//	int						rtcode = SECTION_PARSE_NO_ERROR;
//	uint8_t*				ptemp;
//	int						stream_error;
...
//					pdsmccDownloadDataHeader->TxOrDnloadID = BYTES_get(&bytes, 4);
...
//						pdsmccAdaptationHeader->adaptationDataLength = pdsmccDownloadDataHeader->adaptationLength - 1;
//
//						if (pdsmccAdaptationHeader->adaptationDataLength > 0)
//						{
...
//int MPEG2_DSMCC_UNM_DecodeSection(uint8_t *section_buf, int section_size, dsmcc_section_t* pdsmcc_section)
//{
//	int						rtcode = SECTION_PARSE_NO_ERROR;
//
//	uint8_t*				ptemp;
