...
_CDL_EXPORT int DVB_SI_decode_satellite_delivery_system_descriptor(U8* buf, S32 length, psatellite_delivery_system_descriptor_t psatellite_delivery_system_descriptor);
