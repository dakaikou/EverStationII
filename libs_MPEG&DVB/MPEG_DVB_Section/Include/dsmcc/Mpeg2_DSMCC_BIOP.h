...
_CDL_EXPORT int	MPEG2_DSMCC_BIOP_DecodeIOR(BITS_t* pbs, BIOP::IOR_t* pIOR);
_CDL_EXPORT int	MPEG2_DSMCC_BIOP_DecodeBIOPProfileBody(uint32_t profileId_tag, uint32_t profile_data_length, uint8_t* profile_data_byte, BIOP::BIOPProfileBody_t* pBIOPProfileBody);
_CDL_EXPORT int	MPEG2_DSMCC_BIOP_DecodeLiteOptionsProfileBody(uint32_t profileId_tag, uint32_t profile_data_length, uint8_t* profile_data_byte, BIOP::LiteOptionsProfileBody_t* pLiteOptionsProfileBody);

_CDL_EXPORT	int	MPEG2_DSMCC_BIOP_DecodeDirectoryMessage(uint8_t *msg_buf, int msg_length, BIOP::DirectoryMessage_t* pDirectoryMessage);
_CDL_EXPORT	int	MPEG2_DSMCC_BIOP_DecodeFileMessage(uint8_t *msg_buf, int msg_length, BIOP::FileMessage_t* pFileMessage);
