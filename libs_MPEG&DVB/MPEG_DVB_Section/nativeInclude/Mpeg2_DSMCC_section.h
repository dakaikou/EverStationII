...
#include "../compile.h"
#include "dsmcc\Mpeg2_DSMCC_common.h"
...
_CDL_EXPORT	int	MPEG2_DSMCC_UNM_DecodeSection(uint8_t *buf, int length, dsmcc_unm_section_t* pdsmcc_section);
_CDL_EXPORT	int	MPEG2_DSMCC_DDM_DecodeSection(uint8_t *buf, int length, dsmcc_ddm_section_t* pdsmcc_section);
