...
//返回：LPVOID指针
//备注：2018.7 chendelin
_CDL_EXPORT int DVB_MHP_decode_application_descriptor_to_xml(uint8_t* buf, int length, HALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode, application_descriptor_t* pApplicationDescriptor)
{
...
//功能：解析应用名称描述子
//备注：2018.7 chendelin
int DVB_MHP_decode_application_name_descriptor_to_xml(uint8_t* buf, int length, HALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode, application_name_descriptor_t* pApplicationNameDescriptor)
{
	int			rtcode = SECTION_PARSE_NO_ERROR;
...
int DVB_MHP_present_application_name_descriptor_to_xml(HALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode, application_name_descriptor_t* papplication_name_descriptor)
{
	int		rtcode = SECTION_PARSE_NO_ERROR;
	char    pszField[48];
...
//功能：解析传输协议描述子
//备注：2018.7 chendelin
int DVB_MHP_decode_transport_protocol_descriptor_to_xml(uint8_t* buf, int length, HALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode, transport_protocol_descriptor_t* pTransportProtocolDescriptor)
{
	int		 rtcode = SECTION_PARSE_NO_ERROR;
...
int DVB_MHP_present_transport_protocol_descriptor_to_xml(HALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode, transport_protocol_descriptor_t* ptransport_protocol_descriptor)
{
	int		 rtcode = SECTION_PARSE_NO_ERROR;
	char     pszField[48];
	char	 pszProtocol[48];
	...
	{
		DVB_MHP_NumericCoding2Text_ApplicationTransportProtocolID(ptransport_protocol_descriptor->protocol_id, pszProtocol, sizeof(pszProtocol));
...
//功能：解析DVB-J应用位置描述子
//备注：2018.7 chendelin
int DVB_MHP_decode_dvb_j_application_location_descriptor_to_xml(uint8_t* buf, int length, HALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode, dvb_j_application_location_descriptor_t* pApplicationLocationDescriptor)
{
	int		 rtcode = SECTION_PARSE_NO_ERROR;
...
int DVB_MHP_present_dvb_j_application_location_descriptor_to_xml(HALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode, dvb_j_application_location_descriptor_t* pdvb_j_application_location_descriptor)
{
	int		 rtcode = SECTION_PARSE_NO_ERROR;
	char     pszField[64];
