...
//DSM-CC  0x02
int MPEG2_DSMCC_decode_name_descriptor_to_xml(uint8_t* buf, int length, HALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode, name_descriptor_t* pNameDescriptor)
{
...
//DSM-CC  0x06
int MPEG2_DSMCC_decode_location_descriptor_to_xml(uint8_t* buf, int length, HALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode, location_descriptor_t* pLocationDescriptor)
{
	int			rtcode = SECTION_PARSE_NO_ERROR;
	//char		pszTemp[64];
	//BITS_t		bs;
