...
int MPEG2_PSI_present_video_stream_descriptor_to_xml(HALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode, video_stream_descriptor_t* pvideo_stream_descriptor)
{
	int		rtcode = SECTION_PARSE_NO_ERROR;
	char	pszProfile[32];
	char	pszLevel[32];
...
//返回：LPVOID指针
//备注：2000.11 chendelin
int MPEG2_PSI_decode_registration_descriptor_to_xml(uint8_t *buf, int length, HALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode, registration_descriptor_t* pRegistrationDescriptor)
{
	int		rtcode = SECTION_PARSE_NO_ERROR;
...
//返回：LPVOID指针
//备注：2000.11 chendelin
int MPEG2_PSI_decode_data_stream_alignment_descriptor_to_xml(uint8_t* buf, int length, HALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode, data_stream_alignment_descriptor_t* pDataStreamAlignmentDescriptor)
{
	int		rtcode = SECTION_PARSE_NO_ERROR;
...
//0x13
int MPEG2_DSMCC_decode_carousel_identifier_descriptor_to_xml(uint8_t* buf, int length, HALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode, carousel_identifier_descriptor_t* pCarouselIdentifierDescriptor)
{
	int	  rtcode = SECTION_PARSE_NO_ERROR;
	//char  pszTemp[64];
	//BITS_t bs;
...
//0x14
int MPEG2_DSMCC_decode_association_tag_descriptor_to_xml(uint8_t* buf, int length, HALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode, association_tag_descriptor_t* pAssociationTagDescriptor)
{
	int			rtcode = SECTION_PARSE_NO_ERROR;
	//int			N2;
	//uint8_t*	porigin = buf;
