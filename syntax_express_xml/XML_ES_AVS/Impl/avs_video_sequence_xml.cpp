...
int avs_present_unknown_nal_to_xml(uint8_t *nal_buf, int nal_length, TALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode)
{
	int rtcode = AVS_NO_ERROR;
...
int	avs_decode_pb_picture_header_to_xml(uint8_t* nal_buf, int nal_length, AVS_global_param_t* pparam, TALForXMLDoc* pxmlDoc, tinyxml2::XMLElement* pxmlParentNode, AVS_pb_picture_header_t* pPBPictureHeader)
{
	int		rtcode = AVS_NO_ERROR;
	//char pszTemp[64];
...
int avs_decode_slice_to_xml(uint8_t* nal_buf, int nal_length, AVS_global_param_t* pparam, TALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode, AVS_slice_t* pSliceParam)
{
