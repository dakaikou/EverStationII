...
int mpga_present_unaligned_nal_to_xml(uint8_t* nal_buf, int nal_size, TALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode)
{
...
int mpga_present_unknown_nal_to_xml(uint8_t* nal_buf, int nal_size, TALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode)
{
	int rtcode = MPA_NO_ERROR;
...
int	mpga_decode_frame_to_xml(uint8_t* es_frame_buf, int es_frame_size, TALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode, MPA_frame_t* pMpaFrame)
{
...
int	mpga_present_frame_to_xml(TALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode, MPA_frame_t* pmpa_frame)
{
	int		rtcode = MPA_UNKNOWN_ERROR;
	char    pszID[32];
	char	pszLayer[32];
