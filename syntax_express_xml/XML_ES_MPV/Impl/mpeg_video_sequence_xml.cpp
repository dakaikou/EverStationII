...
int mpgv_present_unknown_nal_to_xml(uint8_t* nal_buf, int nal_length, TALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode)
{
	int rtcode = MPV_NO_ERROR;
...
int mpgv_decode_sequence_header_to_xml(uint8_t* nal_buf, int nal_length, TALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode, MPGV_sequence_header_t* pSequenceHeader)
{
...
int mpgv_present_sequence_header_to_xml(TALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode, MPGV_sequence_header_t* psequence_header)
{
	int		rtcode = MPV_UNKNOWN_ERROR;
...
int	mpgv_decode_group_of_pictures_header_to_xml(uint8_t* nal_buf, int nal_length, TALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode, MPGV_group_of_pictures_header_t* pGOPHeader)
{
	int		rtcode = MPV_UNKNOWN_ERROR;
...
int	mpgv_present_group_of_pictures_header_to_xml(TALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode, MPGV_group_of_pictures_header_t* pgroup_of_pictures_header)
{
	int		rtcode = MPV_UNKNOWN_ERROR;
	char	pszComment[64];
...
int mpgv_decode_picture_header_to_xml(uint8_t* nal_buf, int nal_length, TALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode, MPGV_picture_header_t* pPictureHeader)
{
	int		rtcode = MPV_NO_ERROR;
...
int mpgv_present_picture_header_to_xml(TALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode, MPGV_picture_header_t* ppicture_header)
{
	int		rtcode = MPV_NO_ERROR;
...
int mpgv_decode_sequence_extension_to_xml(uint8_t* nal_buf, int nal_length, TALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode, MPGV_sequence_extension_t* pSequenceExtension)
{
	int		rtcode = MPV_UNKNOWN_ERROR;
...
int mpgv_present_sequence_extension_to_xml(TALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode, MPGV_sequence_extension_t* psequence_extension)
{
	int		rtcode = MPV_UNKNOWN_ERROR;
	char	pszProfile[16];
	char	pszLevel[16];
...
int mpgv_decode_sequence_display_extension_to_xml(uint8_t* nal_buf, int nal_length, TALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode, MPGV_sequence_display_extension_t* pSequenceDisplayExtension)
{
	int		rtcode = MPV_UNKNOWN_ERROR;
...
int mpgv_present_sequence_display_extension_to_xml(TALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode, MPGV_sequence_display_extension_t* psequence_display_extension)
{
	int		rtcode = MPV_UNKNOWN_ERROR;
...
int mpgv_decode_picture_coding_extension_to_xml(uint8_t* nal_buf, int nal_length, TALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode, MPGV_picture_coding_extension_t* pPictureCodingExtension)
{
	int		rtcode = MPV_UNKNOWN_ERROR;
...
int mpgv_present_picture_coding_extension_to_xml(TALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode, MPGV_picture_coding_extension_t* ppicture_coding_extension)
{
	int		rtcode = MPV_UNKNOWN_ERROR;
...
int	mpgv_decode_user_data_to_xml(uint8_t* nal_buf, int nal_length, TALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode, MPGV_user_data_t* pUserData)
{
	int rtcode = MPV_NO_ERROR;
...
int	mpgv_present_user_data_to_xml(TALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode, MPGV_user_data_t* puser_data)
{
	int rtcode = MPV_NO_ERROR;
...
int mpgv_decode_slice_to_xml(uint8_t* nal_buf, int nal_length, TALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode, MPGV_slice_t* pSliceParam)
{
	int		rtcode = MPV_UNKNOWN_ERROR;
...
int mpgv_present_slice_to_xml(TALForXMLDoc* pxmlDoc, XMLElement* pxmlParentNode, MPGV_slice_t* pslice)
{
	int		rtcode = MPV_UNKNOWN_ERROR;
	char  pszField[128];
