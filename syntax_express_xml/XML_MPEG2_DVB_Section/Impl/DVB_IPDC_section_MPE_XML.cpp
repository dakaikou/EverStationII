...
/////////////////////////////////////////////
int DVB_IPDC_MPE_DecodeSection_to_XML(uint8_t *section_buf, int section_size, TALForXMLDoc* pxmlDoc, datagram_section_t* pMPESection)
{
...
int DVB_IPDC_MPE_PresentSection_to_XML(TALForXMLDoc* pxmlDoc, datagram_section_t* pmpe_section)
{
	int	 rtcode = SECTION_PARSE_NO_ERROR;
	char pszComment[128];
	char pszField[64];
