...
/////////////////////////////////////////////
int DVB_MHP_AIT_DecodeSection_to_XML(uint8_t *section_buf, int section_size, TALForXMLDoc* pxmlDoc, application_information_section_t* pAITSection)
{
...
int DVB_MHP_AIT_PresentSection_to_XML(TALForXMLDoc* pxmlDoc, application_information_section_t* pait_section)
{
	int	 rtcode = SECTION_PARSE_NO_ERROR;
