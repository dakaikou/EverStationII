...
/////////////////////////////////////////////
int DVB_SI_BAT_PresentSection_to_XML(TALForXMLDoc* pxmlDoc, bouquet_association_section_t* pbat_section)
{
...
int DVB_SI_BAT_DecodeSection_to_XML(uint8_t *section_buf, int section_size, TALForXMLDoc* pxmlDoc, bouquet_association_section_t* pBATSection)
{
	int		 rtcode = SECTION_PARSE_NO_ERROR;
