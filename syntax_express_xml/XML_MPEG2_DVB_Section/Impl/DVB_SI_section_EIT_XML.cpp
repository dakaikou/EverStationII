...
/////////////////////////////////////////////
int DVB_SI_EIT_PresentSection_to_XML(TALForXMLDoc* pxmlDoc, event_information_section_t* peit_section)
{
...
int DVB_SI_EIT_DecodeSection_to_XML(uint8_t *section_buf, int section_size, TALForXMLDoc* pxmlDoc, event_information_section_t* pEITSection)
{
	int		rtcode = SECTION_PARSE_NO_ERROR;
