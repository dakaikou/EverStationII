...
/////////////////////////////////////////////
int DVB_SI_SDT_PresentSection_to_XML(TALForXMLDoc* pxmlDoc, service_description_section_t* psdt_section)
{
...
int DVB_SI_SDT_DecodeSection_to_XML(uint8_t *section_buf, int section_size, TALForXMLDoc* pxmlDoc, service_description_section_t* pSDTSection)
{
	int		 rtcode = SECTION_PARSE_NO_ERROR;
