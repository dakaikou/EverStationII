...
/////////////////////////////////////////////
int DVB_SI_TDT_PresentSection_to_XML(TALForXMLDoc* pxmlDoc, time_date_section_t* ptdt_section)
{
...
int DVB_SI_TDT_DecodeSection_to_XML(uint8_t *section_buf, int section_size, TALForXMLDoc* pxmlDoc, time_date_section_t* pTDTSection)
{
	int		rtcode = SECTION_PARSE_NO_ERROR;
