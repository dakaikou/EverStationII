...
int MPEG2_DSMCC_DecodeSection_to_XML(uint8_t *section_buf, int section_size, TALForXMLDoc* pxmlDoc, dsmcc_section_t* pDSMCCSection)
{
...
int MPEG2_DSMCC_PresentSection_to_XML(TALForXMLDoc* pxmlDoc, dsmcc_section_t* pdsmcc_section)
{
	int						rtcode = SECTION_PARSE_NO_ERROR;
	char					pszComment[128];
	char					pszField[64];
