...
/*********************************************************************************
	...
	返回：0					-- 信息头未发生变化
		  1					-- 信息头发生变化
*********************************************************************************/
int	aac_audio_decode_adts_fixed_header(unsigned char* adts_fixed_header_buf, int adts_fixed_header_length, AAC_adts_fixed_header_t* padts_fixed_header)
{
	BITS_t	bs;
...
//int	aac_audio_decode_adts_variable_header(FIFO_t* pbs)
//{
////	::WaitForSingleObject(ghAccessEvent, INFINITE);
//
...
//int	aac_audio_decode_adts_error_check(FIFO_t* pbs)
//{
////	::WaitForSingleObject(ghAccessEvent, INFINITE);
//
