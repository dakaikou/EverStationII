...
//int AAC_DecodeID(uint8_t ID, S8* pszText, int size)
//{
//	if (pszText)
//	{
//		switch (ID)
...
//}
//
//int AAC_DecodeProfile(uint8_t ID, uint8_t profile, S8* pszText, int size)
//{
//	if (pszText)
//	{
...
//int AAC_DecodeChannelConfig(uint8_t channel_configuration, S8* pszText, int size)
//{
//	if (pszText)
//	{
