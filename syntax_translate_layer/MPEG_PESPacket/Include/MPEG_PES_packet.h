...
#       define MPEG2_PES_PACKET_LIB __declspec(dllexport)
#   elif defined(_MPEG_PESPACKET_IMPORT)
#       define MPEG2_PES_PACKET_LIB __declspec(dllimport)
#   else
#       define MPEG2_PES_PACKET_LIB
#   endif
#elif __GNUC__ >= 4
#   define MPEG2_PES_PACKET_LIB __attribute__((visibility("default")))
#else
#   define MPEG2_PES_PACKET_LIB
#endif
...
MPEG2_PES_PACKET_LIB	int	MPEG_decode_PES_packet(uint8_t *buf, int length, PES_packet_t* pPES_packet);
