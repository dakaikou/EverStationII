...
TALForXMLDoc::TALForXMLDoc(void)
{
...
//void TALForXMLDoc::ClearAnchor(XMLElement* pxmlBranchNode)
//{
//	if (pxmlBranchNode != NULL)
//	{
...
XMLElement* TALForXMLDoc::NewRootElement(const char* key_name, const char* pszComment, int field_length)
{
	//m_nTreeLevel = 0;
	//for (int i = 0; i < MAX_TREE_LEVEL; i++)
	//{
...
XMLElement * TALForXMLDoc::NewBranchElement(XMLElement* pxmlParent, const char* key_name, const char* pszComment, int field_length, int sync_offset)
{
...
XMLElement * TALForXMLDoc::NewElementForString(XMLElement* pxmlParent, const char* key_name, const char* pszComment)
{
	XMLElement* pxmlNewElement = XMLDocument::NewElement(key_name);
...
XMLElement * TALForXMLDoc::NewElementForBits(XMLElement* pxmlParent, const char* key_name, uint32_t key_value, int bits, const char* mnemonic, const char* pszComment)
{
...
XMLElement * TALForXMLDoc::NewElementForByteMode(XMLElement* pxmlParent, const char* key_name, uint32_t key_value, int bytes, const char* pszComment)
{
	XMLElement* pxmlNewElement = XMLDocument::NewElement(key_name);
...
XMLElement * TALForXMLDoc::NewElementForByteBuf(XMLElement* pxmlParent, const char* key_name, const uint8_t* byte_buf, int byte_length, const char* pszComment)
{
	char pszTemp[48];
	int	 i;
	XMLElement* pxmlNewElement = XMLDocument::NewElement(key_name);
...
//XMLElement * TALForXMLDoc::NewElementForCharBuf(XMLElement* pxmlParent, const char* key_name, const uint8_t* char_buf, int char_length, const uint8_t* trimmed_char)
//{
//	char* pszComment;
//	char pszTemp[48];
//	int	 i;
...
XMLElement * TALForXMLDoc::NewElementForX64Bits(XMLElement* pxmlParent, const char* key_name, const uint64_t key_value, int bits, const char* mnemonic, const char* pszComment)
{
	assert((bits % 8) == 0);
...
XMLElement* TALForXMLDoc::QueryNodeByKeyName(XMLElement* pxmlParentNode, const char* pszNodeName)
{
