...
#include "../Include/TALForDirectSound.h"

CTALForDirectSound::CTALForDirectSound(void)
{
	m_hAudWnd = NULL;
...
CTALForDirectSound::~CTALForDirectSound()
{
}

void CTALForDirectSound::OpenAudio(HWND hWnd, DSound_AudioInfo_t* pAudInfo)
{
	m_hAudWnd = hWnd;
...
void CTALForDirectSound::CloseAudio(void)
{
...
BOOL CTALForDirectSound::DirectSound_AppData(LPDIRECTSOUNDBUFFER8 lpDsb,						 // The buffer.
...
int CTALForDirectSound::DirectSound_Init(void)
{
//	DSCAPS					 dscaps; 
	WAVEFORMATEX			 wfx; 
...
int CTALForDirectSound::DirectSound_Reset(void)
{
...
int CTALForDirectSound::DirectSound_Term(void)
{
	int	 i;
...
int CTALForDirectSound::DirectSound_Render(uint8_t* buf, int length)
{
