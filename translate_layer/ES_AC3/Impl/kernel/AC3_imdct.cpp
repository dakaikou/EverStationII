...
static uint8_t bit_reverse_512[128] = {
...
static uint8_t bit_reverse_256[64] = {
...
void AC3_imdct_init(void)
{
	...
	memset(&delay, 0x00, sizeof(delay));
}
...
void AC3_imdct(AC3_bsi_t *bsi, AC3_audblk_t *audblk, stream_samples_t samples)
{
	int i;
