...
int DVB_MHP_Num2Text_ApplicationVisibility(int visibility_code, char* pszText, int strSize)
{
	int rtcode = SECTION_PARSE_NO_ERROR;
...
int DVB_MHP_Num2Text_ApplicationTransportProtocolID(uint16_t protocol_id, char* pszText, int size)
{
	int		rtcode = SECTION_PARSE_NO_ERROR;
